...
namespace uicore
{
	...
	void GL1VertexArrayBufferProvider::copy_from(GraphicContext &gc, const TransferBufferPtr &buffer, int dest_pos, int src_pos, int size)
	{
	...
	void GL1VertexArrayBufferProvider::copy_to(GraphicContext &gc, const TransferBufferPtr &buffer, int dest_pos, int src_pos, int size)
	{
