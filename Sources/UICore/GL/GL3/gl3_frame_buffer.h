...
namespace uicore
{
	...
	private:
		...
		bool attach_object(GLenum opengl_attachment, const TexturePtr &texture, int level, int zoffset, GLuint texture_target);
		...
		TexturePtr attached_textures[num_attachment_offsets];
