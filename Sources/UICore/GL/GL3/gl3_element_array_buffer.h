...
namespace uicore
{
	...
	class GL3ElementArrayBuffer : public ElementArrayBuffer
	{
	public:
		GL3ElementArrayBuffer(int size, BufferUsage usage);
		GL3ElementArrayBuffer(const void *data, int size, BufferUsage usage);
