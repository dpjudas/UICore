...
namespace uicore
{
	std::shared_ptr<PixelBuffer> JPEGLoader::load(const std::shared_ptr<IODevice> &iodevice, bool srgb)
	{
	...
	JPEGLoader::JPEGLoader(const std::shared_ptr<IODevice> &iodevice)
