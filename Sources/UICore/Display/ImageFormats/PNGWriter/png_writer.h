...
namespace uicore
{
	...
	{
	public:
		static void save(const std::shared_ptr<IODevice> &iodevice, std::shared_ptr<PixelBuffer> image);
		
	private:
		PNGWriter(const std::shared_ptr<IODevice> &iodevice, std::shared_ptr<PixelBuffer> image);
		void save();
