...
namespace uicore
{
	...
	public:
		...
		static std::shared_ptr<UniformBuffer> create(const std::shared_ptr<GraphicContext> &gc, int size, BufferUsage usage = usage_dynamic_draw);
		static std::shared_ptr<UniformBuffer> create(const std::shared_ptr<GraphicContext> &gc, const void *data, int size, BufferUsage usage = usage_dynamic_draw);
		static std::shared_ptr<UniformBuffer> create(const std::shared_ptr<GraphicContext> &gc, const std::shared_ptr<ProgramObject> &program, const std::string &name, int num_blocks = 1, BufferUsage usage = usage_dynamic_draw);
