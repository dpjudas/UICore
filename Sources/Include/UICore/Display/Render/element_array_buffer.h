...
namespace uicore
{
	...
	public:
		...
		static std::shared_ptr<ElementArrayBuffer> create(GraphicContext &gc, int size, BufferUsage usage = usage_static_draw);
		static std::shared_ptr<ElementArrayBuffer> create(GraphicContext &gc, const void *data, int size, BufferUsage usage = usage_static_draw);
