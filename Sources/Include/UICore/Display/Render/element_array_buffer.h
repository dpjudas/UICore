...
namespace uicore
{
	...
	public:
		...
		static std::shared_ptr<ElementArrayBuffer> create(const GraphicContextPtr &gc, int size, BufferUsage usage = usage_static_draw);
		static std::shared_ptr<ElementArrayBuffer> create(const GraphicContextPtr &gc, const void *data, int size, BufferUsage usage = usage_static_draw);
