...
namespace uicore
{
	...
	public:
		 ...
		 */
		static std::shared_ptr<Texture2D> create(GraphicContext &context, int width, int height, TextureFormat format = tf_rgba8, int levels = 1);
		static std::shared_ptr<Texture2D> create(GraphicContext &context, const Size &size, TextureFormat texture_format = tf_rgba8, int levels = 1);
		...
		virtual void copy_image_from(GraphicContext &context, int level, TextureFormat texture_format = tf_rgba8) = 0;
		virtual void copy_image_from(GraphicContext &context, int x, int y, int width, int height, int level = 0, TextureFormat texture_format = tf_rgba8) = 0;
		...
		virtual void copy_subimage_from(GraphicContext &context, int offset_x, int offset_y, int x, int y, int width, int height, int level = 0) = 0;
		virtual void copy_subimage_from(GraphicContext &context, const Point &offset, const Rect &pos, int level = 0)
		{
