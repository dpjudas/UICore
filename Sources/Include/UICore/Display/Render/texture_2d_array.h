...
namespace uicore
{
	...
	public:
		 ...
		 */
		static std::shared_ptr<Texture2DArray> create(const std::shared_ptr<GraphicContext> &context, int width, int height, int array_size, TextureFormat texture_format = tf_rgba8, int levels = 1);
		static std::shared_ptr<Texture2DArray> create(const std::shared_ptr<GraphicContext> &context, const Size &size, int array_size, TextureFormat texture_format = tf_rgba8, int levels = 1);
		 ...
		 */
		virtual void set_image(const std::shared_ptr<GraphicContext> &context, int array_index, const std::shared_ptr<PixelBuffer> &image, int level = 0) = 0;
		 ...
		 *  \param level       Mipmap level-of-detail number.
		 */
		virtual void set_subimage(const std::shared_ptr<GraphicContext> &context, int array_index, int x, int y, const std::shared_ptr<PixelBuffer> &image, const Rect &src_rect, int level = 0) = 0;
		void set_subimage(const std::shared_ptr<GraphicContext> &context, int array_index, const Point &point, const std::shared_ptr<PixelBuffer> &image, const Rect &src_rect, int level = 0)
		{
