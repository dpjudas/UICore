...
namespace uicore
{
	...
	public:
		...
		void add_unknown_chunk(const std::string &name, const std::shared_ptr<DataBuffer> &chunk_data, PNGUnknownChunkLocation location);
		...
		void set_icc_profile(const std::string &profile_name, const std::shared_ptr<DataBuffer> &profile_data);
