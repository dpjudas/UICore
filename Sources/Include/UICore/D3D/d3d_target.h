...
namespace uicore
{
	...
	public:
		...
		static ID3D11Texture2D *get_texture2d_handle(const GraphicContext &gc, const TexturePtr &texture);

		/// \brief Returns the Direct3D handle used by the pixel buffer object
		///
		/// The reference count on the COM object is not increased (AddRef is not called).
		static ID3D11Texture2D *get_texture2d_handle(const GraphicContext &gc, const PixelBufferPtr &pixel_buffer);

		/// \brief Returns the Direct3D handle used by the render buffer object
		///
		/// The reference count on the COM object is not increased (AddRef is not called).
		static ID3D11Texture2D *get_texture2d_handle(const GraphicContext &gc, const RenderBufferPtr &render_buffer);
		...
		///
		/// The reference count on the COM object is not increased (AddRef is not called).
		static ID3D11Buffer *get_buffer_handle(const GraphicContext &gc, const ElementArrayBufferPtr &buffer);
		...
		///
		/// The reference count on the COM object is not increased (AddRef is not called).
		static ID3D11ShaderResourceView *get_srv_handle(const GraphicContext &gc, const TexturePtr &texture);
