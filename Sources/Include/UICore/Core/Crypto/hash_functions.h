...
namespace uicore
{
	...
	public:
		...
		///
		/// \return String8
		static std::string sha1(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha1(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[20]);
		...
		///
		/// \return String8
		static std::string md5(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void md5(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[16]);
		...
		///
		/// \return String8
		static std::string sha224(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha224(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[28]);
		...
		///
		/// \return String8
		static std::string sha256(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha256(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[32]);
		...
		///
		/// \return String8
		static std::string sha384(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha384(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[48]);
		...
		///
		/// \return String8
		static std::string sha512(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha512(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[64]);
		...
		///
		/// \return String8
		static std::string sha512_224(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha512_224(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[28]);
		...
		///
		/// \return String8
		static std::string sha512_256(const std::shared_ptr<DataBuffer> &data, bool uppercase = false);
		...
		/// \param data = Data Buffer
		/// \param out_hash = char
		static void sha512_256(const std::shared_ptr<DataBuffer> &data, unsigned char out_hash[32]);
	};
}
